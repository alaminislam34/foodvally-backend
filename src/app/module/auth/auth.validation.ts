...
export const createRestaurantZodSchema = z.object({
  password: z.string().min(8, "Password must be at least 8 characters long"),
  user: z.object({
    name: z.string("Name must be a string").min(5, "Name must be at least 5 characters long"),
  ...
  restaurant: z.object({
    ...
    city: z.string("City must be a string").min(2, "City must be at least 2 characters long"),
    address: z.string("Address must be a string").min(5, "Address must be at least 5 characters long"),
    contactNumber: z
    ...
    cuisine: z.string("Cuisine must be a string").min(3, "Cuisine must be at least 3 characters long"),
    openingHours: z
    ...
    coverImage: z.string("Cover image must be a string").url("Cover image must be a valid URL"),
    foodCategories: z
